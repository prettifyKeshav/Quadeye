    ...
    return (
        <div className="job-card">
            <div className="location">
                <figure>
                    <Image src="/assets/icon/location.svg" width={20} height={20} alt="ico" />
                </figure>
            ...
            <div className="bottom-flex">
                <Link href={item.exploreLink} className="btn">Explore</Link>

                <div className="shere-ico">
                    <Image src="/assets/icon/share-ico.svg" width={24} height={24} alt='ico' />
                    <div className="social-icons">
                        ...
                        <Link href="https://in.linkedin.com/company/" target="_blank" rel="noopener noreferrer">
                            <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24"><path d="M6.94 5a2 2 0 1 1-4-.002a2 2 0 0 1 4 .002M7 8.48H3V21h4zm6.32 0H9.34V21h3.94v-6.57c0-3.66 4.77-4 4.77 0V21H22v-7.93c0-6.17-7.06-5.94-8.72-2.91z" /></svg>
                        </Link>
                    </div>
                </div>
            </div>
